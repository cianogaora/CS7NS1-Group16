...
class Device:
    ...
    # Eight types of data generated by calling the sensor in the device
    def __init__(self, pub_id, port):
        ...
        self.id = pub_id
        self.port = port
        # Turn on the network and wait to receive the command to get data from the content router
    ...
    # According to the address of the given Controller, send the post command and send the json file
