...
class Device:
    ...
    # Fangyu: Eight types of data generated by calling the sensor in the device
    ...
    def __init__(self, pub_id, port):
        ...
        # Fangyu: Listen for the command from the content router to send data, and respond
    ...
    # Cian + Fangyu: According to the address of the given Controller, register the device on the network and receive a
